...
namespace iMovie
{
    public class Subscene
    {
        ...
        private string SearchQueryPattern = @"http://subscene.com/subtitles/title.aspx?q=@QUERY@&l=";
        private string EachFoundMovieTagPattern = @"<div class=""title"">\n<a href=""/subtitles/[^/<>"" ]*"">[^<>]*</a>\n</div>";
        private string MovieURLPattern = @"http://subscene.com/subtitles/[^/<>"" ]*";
        private string MovieRootURLPattern = @"http://subscene.com";
    }
} 